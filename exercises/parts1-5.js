...
var Spacecraft = /** @class */ (function () {
    ...
    Spacecraft.prototype.getDayesToLoaction = function (kilometersAway) {
...
console.log("".concat(spaceShuttle.name, " would take ").concat(spaceShuttle.getDayesToLoaction(kilometersToMars), " to get to Mars."));
console.log("".concat(spaceShuttle.name, " would take ").concat(spaceShuttle.getDayesToLoaction(kilometersToTheMoon), " to get to Moon."));
